...
public class Priest extends Heroes{
    ...
    public double especialLeve(double forca, double vida){
        return especial.especialMagico(forca, vida);
    }
    
    public double especialPesado(double forca, double vida){
        return especial.especialUltimate(forca, vida);
    }
